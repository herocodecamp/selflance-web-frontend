      ...
      <div className="mx-4 lg:mx-10">
            ...
            {navList.map((i, index) => {
              return (
                <li className="mr-2" key={index}>
                  <a
                    href="/#"
                    className="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-blue-600 dark:hover:text-gray-300 active"
                  >
                    {i}
                  </a>
                </li>
        ...
        <div className="grid grid-cols-12 grid-flow-col gap-2 md:gap-8 mt-6">
          ...
          <div className="col-span-full md:col-start-1 md:col-span-8 flex flex-col">
            <div className="text-xl lg:text-5xl font-bold">{gig.title}</div>
            {/* carousel */}
            <div className="object-center mt-5 md:mt-10 mb-5">
              <img
                src={`http://localhost:8000/${
                  gig?.gigImages?.slice(0, gig.gigImages.length)[
                    currentImageIndex
                  ]?.url
                }`}
                alt=""
                className="rounded-lg object-center w-full h-auto"
              />
              <div className="flex items-center justify-center mt-1">
                <button
                  type="button"
                  onClick={previousImageIndex}
                  className="cursor-pointer p-1 md:p-2 w-6 h-6 text-white bg-black rounded-full  md:w-8 md:h-8 dark:text-gray-800 bg-opacity-30"
                >
                  <FaArrowLeft />
                </button>
                <button
                  ...
                  className="ml-20 cursor-pointer p-1 md:p-2 w-6 h-6 text-white bg-black rounded-full  md:w-8 md:h-8 dark:text-gray-800 bg-opacity-30"
                >
                  {" "}
                  <FaArrowRight />
                </button>
                        ...
                        <img
                          ...
                          className={
                            currentImageIndex === index
                              ? `border-4 border-solid border-[#00538F] rounded-lg`
                              : ""
                          }
                        />
                      </div>
                ...
                <div>
                  ...
                  >
                    <div className="flex flex-row items-center">
                      <p className="text-xl font-normal mt-0">Details</p>{" "}
                      <FaChevronDown />
                    </div>
                  </button>
                  <div className="my-3">
                  ...
                  <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                      <tr>
                        <th
                          scope="col"
                          className="px-2 md:px-6 py-3 border-r-2"
                        >
                          Packages
                        </th>
                    ...
                    <tbody>
                      <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <th
                          scope="row"
                          className="px-2 md:px-6 py-3 border-r-2 text-gray-900 whitespace-nowrap dark:text-white"
                        >
                          Summary
                        </th>
                        {gig.packages.map((item, index) => {
                          return (
                            <td
                              className="px-1 md:px-6 py-4 text-xs border-r-2"
                              key={index}
                            >
                              {item.summary}
                            </td>
                      ...
                      <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <th
                          scope="row"
                          className="px-2 md:px-6 py-3 border-r-2 font-medium text-gray-900 whitespace-nowrap dark:text-white"
                        >
                          Prototype
                        </th>
                        {gig.packages.map((item, index) => {
                      ...
                      <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <th
                          scope="row"
                          className="px-6 py-4 border-r-2 font-medium text-gray-900 whitespace-nowrap dark:text-white"
                        >
                          No. of Revisions
                        </th>
                        {gig.packages.map((item, index) => {
                      ...
                      <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <th
                          scope="row"
                          className="px-6 py-4 font-medium border-r-2 text-gray-900 whitespace-nowrap dark:text-white"
                        ></th>
                        {gig.packages.map((item, index) => {
                          return (
                            <td className="px-6 py-4 border-r-2" key={index}>
                              <button
                                className="bg-[#00538F] w-[120px] text-white font-medium text-lg rounded-md"
                                onClick={() =>
                                  handleOfferClick(index, gig?._id)
                                }
                              >
                                Select
                              </button>
            ...
            {/* About the Seller */}
            <div className="text-2xl font-medium my-2 md:my-5 ">
              About the Seller
            </div>
            <div className="border border-solid border-#D1D1D1 rounded-lg p-3 md:p-8 my-5 md:my-10">
              <div className="grid grid-cols-12">
                <div className="col-start-1 col-span-4 lg:col-span-2">
                  <span>
                    <img
                      ...
                      alt="pic"
                      className="flex-initial w-[125px] h-auto rounded-full overflow-hidden self-center"
                    />
                  </span>
                </div>
                <div className="col-start-5 lg:col-start-3 col-span-6 lg:col-span-3 items-center ml-3 lg:ml-2">
                  ...
                  <p className="text-[#FFB33E] font-bold text-sm md:text-base ">
                    {userDetails.rating}
                  </p>
                  <p className="text-[#27AE60] text-sm md:text-base">
                    {userDetails.status}
                  </p>
                </div>
              </div>
              ...
              <div className="hidden md:grid md:grid-cols-8 md:gap-10 md:justify-start">
                <div className="col-start-1 col-span-2">
                  ...
                  <h2 className="text-sm md:text-lg font-medium mt-3">
                    {userDetails.country}
                  </h2>
                </div>
              ...
              <div className="">
                <div className="flex justify-between mt-5 md:mt-10">
                  ...
                  <div className="flex flex-row items-center">
                    ...
                    <img
                      src={RatingStar}
                      className="flex-initial w-[10px] md:w-[17.79px] h-[9px] md:h-[16.42px] ml-3 "
                      alt=""
                    />{" "}
                    <p className="text-sm ml-1">4.9</p>
                  </div>
                  <div>
                    <label for="filter" className="border-none mr-2"></label>
                    <select
                      id="filter"
                      className=" border-none text-xs md:text-sm font-medium text-[#828282] mr-2"
                    >
                ...
                <div>
                              ...
                              <div
                                className={
                                  activePkgTab === item
                                    ? `col-start-${
                                        index + 1
                                      } col-span-1 md:px-3 border-r border-gray-200 dark:border-gray-700 bg-[#00538F] text-white`
                                    : `col-start-${
                                        index + 1
                                      } col-span-1 md:px-3 border-r border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400`
                                }
                              >
                                <li className="">
                                  <button
                                    className=" text-xs md:text-sm h-[35.23px] md:h-[52.23px] font-medium block"
                                    onClick={() => {
                                      setActiveIndex(index);
                                      setActivePkgTab(item);
                                    }}
                                  >
                                    {item}
                                  </button>
                  ...
                  <div className="p-1 md:p-5">
                    ...
                    <div className="grid grid-cols-2 my-5">
                      ...
                      <div className="col-start-2 col-span-1 place-self-end text-xs md:text-sm font-medium">
                        {gig.packages[activeIndex].prototype === true ? (
                          <BsCheck />
                        ) : (
                          ""
                        )}
                    ...
                    <div className="grid grid-cols-2 my-5">
                      ...
                      <div className="col-start-2 col-span-1 place-self-end text-xs md:text-sm font-medium">
                        {gig.packages[activeIndex].sourceFile === true ? (
                          <BsCheck />
                        ) : (
                          ""
                        )}
                    ...
                    <div className=" grid grid-cols-1">
                      <div className="col-span-full place-self-center">
                        <button
                          className="bg-[#00538F] text-white rounded-lg w-[100px] xl:w-[350px] h-[30px] md:h-[47px] text-xs lg:text-lg font-medium"
                          onClick={() => {
                            handleOfferClick(activeIndex);
                          }}
                        >
                          Select Offer
                        </button>
            ...
            <div className="border border-solid border-[/#D1D1D1] rounded-lg p-2 md:p-8 items-center">
              <div className="flex flex-row items-center justify-center">
                <img
                  src={`http://localhost:8000/${user.profileImage}`}
                  alt="pic"
                  className="inline-block object-center w-[77px] h-auto rounded-full"
                />
              </div>
              <div className="text-center text-lg font-medium">
                {user.firstname} {user.lastname}
              </div>
              <div className="text-center text-[#FFB33E] text-sm font-medium mt-1">
                {userDetails.rating}
              </div>
              <div className="text-center mb-5 mt-3 mx-5 md:mx-0 ">
                <button className="bg-[#00538F] text-white rounded-lg w-[180px]  xl:w-[400px] h-[25px]  lg:h-[57px] sm:text-sm lg:text-lg font-medium">
                  Contact this Seller
                </button>
              </div>
              <hr />
