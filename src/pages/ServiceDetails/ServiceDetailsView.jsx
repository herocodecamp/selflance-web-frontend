            ...
            {navList.map((i, index) => {
              return (
                <li class="mr-2" key={index}>
                  <a
                    href="/#"
                    class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-blue-600 dark:hover:text-gray-300 active"
                  >
                    {i}
                  </a>
                </li>
        ...
        <div class="grid grid-cols-12 grid-flow-col gap-2 md:gap-8 mt-6">
          ...
          <div class="col-span-full md:col-start-1 md:col-span-8 flex flex-col">
            ...
            <div class="object-center mt-5 md:mt-10 mb-5 mr-4">
              <img
                src={images.slice(0, 4)[currentImageIndex]}
                alt=""
              ...
              <div class="flex items-center justify-center mt-1">
                <button
                  ...
                  class="cursor-pointer p-1 md:p-2 w-6 h-6 text-white bg-black rounded-full  md:w-8 md:h-8 dark:text-gray-800 bg-opacity-30"
                >
                  <FaArrowLeft />
                </button>
                <button
                  ...
                  class="ml-20 cursor-pointer p-1 md:p-2 w-6 h-6 text-white bg-black rounded-full  md:w-8 md:h-8 dark:text-gray-800 bg-opacity-30"
                >
                  {" "}
                  <FaArrowRight />
                </button>
                ...
                <div>
                  <button class="" onClick={() => setShowDetails(!showDetails)}>
                    <div class="flex flex-row items-center">
                      <p class="text-xl font-normal mt-0">Details</p>{" "}
                      <FaChevronDown />
                    </div>
                  </button>
                  <div class="my-3">
                  ...
                  <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                      ...
                      <tr>
                        ...
                        {Packages.map((item, index) => {
                          return (
                            <th
                              scope="col"
                              class="px-2 md:px-6 py-3 border-r-2"
                              key={index}
                            >
                              {item}
                            </th>
                    ...
                    <tbody>
                      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <th
                          scope="row"
                          class="px-2 md:px-6 py-3 border-r-2 text-gray-900 whitespace-nowrap dark:text-white"
                        >
                          Summary
                        </th>
                        {packageData.map((item, index) => {
                          return (
                            <td
                              class="px-1 md:px-6 py-4 text-xs border-r-2"
                              key={index}
                            >
                              {item.summary}
                            </td>
                      ...
                      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <th
                          scope="row"
                          class="px-2 md:px-6 py-3 border-r-2 font-medium text-gray-900 whitespace-nowrap dark:text-white"
                        >
                          Prototype
                        </th>
                        {packageData.map((item, index) => {
                      ...
                      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <th
                          scope="row"
                          class="px-6 py-4 border-r-2 font-medium text-gray-900 whitespace-nowrap dark:text-white"
                        >
                          No. of Revisions
                        </th>
                        {packageData.map((item, index) => {
                      ...
                      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <th
                          scope="row"
                          class="px-6 py-4 font-medium border-r-2 text-gray-900 whitespace-nowrap dark:text-white"
                        ></th>
                        {Packages.map((item, index) => {
                          return (
                            <td class="px-6 py-4 border-r-2" key={index}>
            ...
            {/* About the Seller */}
            <div class="text-2xl font-medium my-2 md:my-5 ">
              About the Seller
            </div>
            <div class="border border-solid border-#D1D1D1 rounded-lg p-3 md:p-8 my-5 md:my-10">
              <div class="grid grid-cols-12">
                <div class="col-start-1 col-span-4 lg:col-span-2">
                  <span>
                    <img
                      ...
                      alt="pic"
                      class="flex-initial w-[125px] h-auto rounded-full overflow-hidden self-center"
                    />
                  </span>
                </div>
                <div class="col-start-5 lg:col-start-3 col-span-6 lg:col-span-3 items-center ml-3 lg:ml-2">
                  ...
                  <p class="text-[#FFB33E] font-bold text-sm md:text-base ">
                    {userDetails.rating}
                  </p>
                  <p class="text-[#27AE60] text-sm md:text-base">
                    {userDetails.status}
                  </p>
                </div>
              </div>
              ...
              <div class="hidden md:grid md:grid-cols-8 md:gap-10 md:justify-start">
                <div class="col-start-1 col-span-2">
                  ...
                  <h2 class="text-sm md:text-lg font-medium mt-3">
                    {userDetails.country}
                  </h2>
                </div>
              ...
              <div class="">
                <div class="flex justify-between mt-5 md:mt-10">
                  ...
                  <div class="flex flex-row items-center">
                    ...
                    <img
                      src={RatingStar}
                      class="flex-initial w-[10px] md:w-[17.79px] h-[9px] md:h-[16.42px] ml-3 "
                      alt=""
                    />{" "}
                    <p class="text-sm ml-1">4.9</p>
                  </div>
                  <div>
                    <label for="filter" class="border-none mr-2"></label>
                    <select
                      id="filter"
                      class=" border-none text-xs md:text-sm font-medium text-[#828282] mr-2"
                    >
                ...
                <div>
                          ...
                          return (
                            <div class="object-center">
                              ...
                              >
                                <li class="">
                                  <button
                                    class=" text-xs md:text-sm h-[35.23px] md:h-[52.23px] font-medium block"
                                    onClick={() => {
                  ...
                  <div class="p-1 md:p-5">
                    ...
                    <div class="grid grid-cols-2 my-5">
                      ...
                      <div class="col-start-2 col-span-1 place-self-end text-xs md:text-sm font-medium">
                        {packageData[activeIndex].prototype === true ? (
                          <BsCheck />
                        ) : (
                          ""
                        )}
                    ...
                    <div class="grid grid-cols-2 my-5">
                      ...
                      <div class="col-start-2 col-span-1 place-self-end text-xs md:text-sm font-medium">
                        {packageData[activeIndex].sourcefile === true ? (
                          <BsCheck />
                        ) : (
                          ""
                        )}
                    ...
                    <div class=" grid grid-cols-1">
                      <div class="col-span-full place-self-center">
                        <button
                          class="bg-[#00538F] text-white rounded-lg w-[100px] xl:w-[350px] h-[30px] md:h-[47px] text-xs lg:text-lg font-medium"
                          onClick={() => {
            ...
            <div class="border border-solid border-[/#D1D1D1] rounded-lg p-2 md:p-8 items-center">
              <div class="flex flex-row items-center justify-center">
                <img
                  src={userDetails.image}
                  alt="pic"
                  class="inline-block object-center w-[77px] h-auto rounded-full"
                />
              </div>
              <div class="text-center text-lg font-medium">
                {userDetails.name}
              </div>
              <div class="text-center text-[#FFB33E] text-sm font-medium mt-1">
                {userDetails.rating}
              </div>
              <div class="text-center mb-5 mt-3 mx-5 md:mx-0 ">
                <button class="bg-[#00538F] text-white rounded-lg w-[180px]  xl:w-[400px] h-[25px]  lg:h-[57px] sm:text-sm lg:text-lg font-medium">
                  Contact this Seller
                </button>
              </div>
              <hr />
