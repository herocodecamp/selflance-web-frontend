  ...
  return (
    <div className='px-12 py-4'>
      ...
      <div className='sm:pt-16 pt-6 '>
        <div className='bg-[#FFFFFF] rounded-3xl drop-shadow-lg sm:w-1/2 mx-auto w-full sm:py-8 px-6 text-center space-y-6'>
          ...
          <div class="relative rounded-md shadow-sm ">
            ...
            <button
              type="button"
              class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-[#00538F] text-white hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
            >
      ...
      <div className='py-12 text-center'>
        <button
          ...
          className={`font-bold text-base ${selectedFile ? 'bg-[#00538F]' : 'bg-[#80A9C7]'}  text-white sm:px-4 sm:py-2 px-2 py-1  rounded-lg`}
...
export default SubmiteRequirement;