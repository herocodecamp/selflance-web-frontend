...
const PricePickerView = ({name, onChange, onBlur, value}) => {
  return (
    <div className="flex text-2xl">
        ...
        <div className='flex items-center justify-center'>
            ...
            <input type="text" className="rounded-none border-l-0 text-2xl border-r-0 border-gray-300 text-gray-900 block px-0 py-4 w-20 " placeholder="0" value={value} name={name} onChange={onChange} onBlur={onBlur} />
        </div>
