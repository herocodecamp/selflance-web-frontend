...
const ManageDetails = ({ manage }) => {
  return (
    <div class='mt-4'>
      ...
      <div class='grid grid-cols-5 gap-1 flex-wrap border border-solid border-gray-300 shadow-lg bg-[#FFFFFF] rounded-md lg:rounded-2xl p-2 md:p-4'>
        <div class="col-start-1 col-span-2">
          <img src={manage.image} class="inline h-[110px] md:h-[220px] lg:h-[350px] w-auto rounded-lg" alt="img" />
        </div>

        <div class='col-start-3 col-span-3 md:space-y-3 lg:space-y-6 ml-1 md:ml-5'>
