  ...
  return (
    <div className='space-y-4 pt-6'>
      <div className='flex items-center justify-between'>
        <p>Count down</p>
        <p className='sm:text-xl text-sm font-semibold sm:font-bold'>Day : <span className='text-xl text-[#D57635]'>03</span> : : Hours : <span className='text-xl text-[#00538F]'>24</span> : : Minutes : <span className='text-xl text-[#00538F]'>30</span></p>
      </div>
      <div className='sm:flex flex-grow  border border-solid border-gray-300 shadow-lg bg-[#FFFFFF] p-2 space-x-6 relative'>
        <div>
          <img src={manage.image} className=" w-full h-full mx-auto justify-center items-center rounded-lg" alt="img" />
        </div>
        ...
        <div className='space-y-6'>
          ...
          <div className='flex'>
            ...
            <div>
              ...
              <button className='bg-[#27AE60] border border-[#27AE60] sm:px-4 px-2 py-1 rounded text-white absolute sm:right-6 sm:top-6 mt-2 sm:mt-0 right-2 truncate'>In progress</button>
