        ...
        <div className='space-y-6'>
          ...
          <div className='flex'>
            ...
            <div>
              ...
              <button className='bg-[#27AE60] border border-[#27AE60] px-4 py-1 rounded text-white absolute right-6 top-6'>In progress</button>
          ...
          <div className='flex space-x-12'>
            ...
            <button className='bg-[#27AE60] px-6 py-1 font-bold text-sm border border-[#27AE60] text-white rounded'>requirement send</button>
