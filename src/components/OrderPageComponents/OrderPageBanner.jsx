  ...
  return (
    <div className="border shadow-md flex-none md:flex rounded-xl md:my-10">
      ...
      <div className="my-2 mx-2 md:mx-3 md:my-4 space-y-2 sm:space-y-4 md:space-y-6 xl:space-y-7">
        <h2 className="text-2xl sm:text-3xl md:text-[2rem] xl:text-5xl font-semibold">Mobile UI UX design or app UI UX design</h2>
        ...
        <p className="text-slate-500 text-xl sm:text-2xl md:text-3xl font-normal">Basic: <span className="text-slate-900">$30</span></p>
      </div>
    </div>
  );
};
