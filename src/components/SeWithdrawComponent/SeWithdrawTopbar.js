      ...
      <div className='py-4 px-2 sm:px-6   my-6 flex items-center justify-between  bg-[#FFFFFF] drop-shadow-2xl rounded-lg '>
        <div className='sm:px-6 sm:py-4 px-4 py-4 sm:space-y-6 space-y-4'>
          <div className='space-y-2 w-1/2'>
            <h3 className='text-[#00538F] text-xl lg:text-2xl font-bold leading-6 lg:leading-10'>${seller_balance.personal_balance}</h3>
            <p className='text-[#00538F] font-sm text-base'>personal balance
            </p>
          </div>

          <button className='bg-[#00538F] text-white w-[120px] sm:w-[160px] lg:w-[200px] px-6 py-3 font-bold rounded-md'>Withdraw</button>
        </div>
        ...
        <div className='flex items-center w-1/2  justify-between relative'>
          ...
          <div className=' sm:py-4 px-4 py-4 sm:space-y-6 space-y-4'>
            <div className='space-y-2'>
              <h2 className='text-[#404040] text-xl sm:text-2xl font-bold'>This month</h2>

              <h3 className='text-[#00538F] text-xl lg:text-2xl font-bold leading-6 lg:leading-10'>${seller_balance.current_month_earning}</h3>
              <p className='text-[#00538F] font-sm text-base'>personal balance
              </p>
            </div>
            <p className='text-[#000000] text-base sm:text-xl font-sm'>Pending Payment: ${seller_balance.pending_payment}</p>
          </div>
          <div>
            <span className='absolute top-3 right-0 hover:cursor-pointer sm:right-4'><AiOutlineCalendar className='text-[#707B81] w-[30px] h-[30px]' /></span>
          </div>
        </div>
