...
import DSellerDetails from './DSellerDetails';
...
const DPremiupSeller = () => {
  return (
    <div className='py-6'>
      <h2 className='text-[#00538F] font-bold text-xl leading-4 py-4'>Premium Sellers</h2>
      <div className='grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 '>
        {
          Gigs?.slice(0, 3).map(gig => <DSellerDetails
            key={gig._id}
            gig={gig}
          ></DSellerDetails>)
        }
