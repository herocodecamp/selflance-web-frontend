    ...
    <div className='px-2 sm:px-12 w-full'>
      ...
      <div className='px-4 py-2 sm:px-8 sm:py-4 bg-[#00538F] drop-shadow-lg rounded-lg space-y-2'>
        ...
        <div className='sm:flex items-center justify-between'>
          ...
          <div>
            <h4 className='leading-4 sm:leading-6 lg:leading-10 text-xl sm:text-2xl lg:text-4xl font-bold text-white'>Hi {sellerInfo.name}</h4>
            <h5 className='leading-4 sm:leading-6 lg:leading-10 text-base sm:text-2xl lg:text-3xl text-white flex items-center space-x-1'> <span>{sellerInfo.country}</span><span className='font-bold text-2xl'>.</span>  <span></span>{sellerInfo.level}</h5>
          </div>
          ...
          <div className='flex items-center space-x-4 bg-[#FFFFFF] px-4 py-4 sm:px-6 sm:py-6 w-[280px] sm:w-[350px] lg:w-[450px] rounded-full'>
            ...
            <div>
              <h5 className='text-[#121F3E] text-sm lg:text-base font-semibold'>{sellerInfo.rating}% to</h5>
              <p className='text-[#B8BCC5] text-sm lg:text-base font-semibold'>{sellerInfo.level}</p>
            </div>
            <span><AiOutlineRight className='text-[#121F3E] text-xl sm:text-2xl' /></span>
          </div>
