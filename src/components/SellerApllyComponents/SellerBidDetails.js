      ...
      <div className='space-y-4 sm:space-y-8'>
        ...
        <div>
          <form>
            <div className="space-y-4">
              ...
              <div className='space-y-4'>
                <label className='text-[#15151E] text-base font-bold'>Cover Letter</label>
                <textarea
                  className='w-11/12 sm:w-full resize-none text-[#8E8E8E] border-2 border-[#E3E3E3] px-4 py-2 pr-8 rounded  shadow leading-tight'
                  name="description" cols="30" rows="10" placeholder='write your cover letter...'></textarea>
              </div>
        ...
        <div className='text-center sm:pt-6'>
          ...
          <button
            ...
            className={`font-bold text-base ${selectedFile ? 'bg-[#00538F]' : 'bg-[#80A9C7]'}  text-white sm:px-6 sm:py-2 px-4 py-2  rounded-lg`}
          >Submit</button>
        </div>
